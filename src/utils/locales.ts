...
const PACKAGE_DEFAULTS: LocalesProps = {
  ...
  "ConfigResetSuccessTitle": "Config Reset",
  "ConfigResetSuccessBody": "All settings have been restored to their defaults.",
  "ConfigResetFailedTitle": "Reset Failed",
  "ConfigResetFailedBody": "Couldn't reset the config — check the server console.",
  "ConfigSaveSuccessTitle": "Saved",
  "ConfigSaveSuccessBody": "Your changes have been saved.",
  "ConfigSaveFailedTitle": "Save Failed",
  "ConfigSaveFailedBody": "Couldn't save your changes — check the server console.",
  "ConfigSaveNotReadyBody": "Config isn't ready yet — try again in a moment.",
